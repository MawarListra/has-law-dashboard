...
import { ApiGetAllPartner, ApiDeletePartner } from "@/hooks/use-fetch";
...
function MainContentPartner() {
  ...
  /* FETCH DATA */
  // [GET] All Partner   ===> command for a while
  ApiGetAllPartner({
    params: {
      page: 1,
      pagesize: 100,
  ...
  // [DELETE] Partner
  const deletePartner = ApiDeletePartner({
    onSuccess() {
      setDeletePopup({
        open: false,
        selectedId: null,
...
export default MainContentPartner;
