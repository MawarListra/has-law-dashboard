...
const InvoiceBody = ({ data = defData }) => (
  <View style={styles.body}>
        ...
        return (
          ...
          >
            <View style={{ display: "flex", flexDirection: "column" }}>
              <Text>{e?.menu?.name}</Text>
              <Text>
                {e?.quantity || 0}x @{formatToCurrency(e?.price ?? 0)}
              </Text>
            </View>
            <Text>{formatToCurrency(e?.total ?? 0, true) || "-"}</Text>
          </View>
        );
      })}
    </View>
    ...
    >
      ...
      >
        <Text>Subtotal</Text>
        <Text>{formatToCurrency(data?.sub_total ?? 0, true) || "-"}</Text>
      </View>
      <View
        style={{
          display: "flex",
      ...
      >
        <Text>Total</Text>
        <Text>{formatToCurrency(data?.total ?? 0, true) || "-"}</Text>
      </View>
    </View>
    <View
      style={{
...
const OrderBody = ({ data = defData }) => (
  ...
  >
    ...
    >
      ...
      >
        <Text style={{ fontSize: 8, textAlign: "center" }}>ORDER BARU</Text>
      </View>
    </View>
    <View
      style={{
