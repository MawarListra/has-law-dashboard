...
import MainContentPublication from "@/components/pages/admin/publication/main-content";

import useAppNav from "@/hooks/use-app-nav";

// import type { GetServerSideProps } from "next";

function PublicationProtectedPage() {
...
export default PublicationProtectedPage;
